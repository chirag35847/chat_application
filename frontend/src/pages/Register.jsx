        ...
        >
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className={`w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2 group transition-all mt-4 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
